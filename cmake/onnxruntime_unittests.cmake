...
function(AddTest)
  ...
  if (${CMAKE_SYSTEM_NAME} STREQUAL "iOS")
    ...
    set_target_properties(${_UT_TARGET} PROPERTIES FOLDER "ONNXRuntimeTest"
      ...
      MACOSX_BUNDLE_LONG_VERSION_STRING ${ONNXRUNTIME_VERSION}
      MACOSX_BUNDLE_BUNDLE_VERSION ${ONNXRUNTIME_VERSION}
      MACOSX_BUNDLE_SHORT_VERSION_STRING ${ONNXRUNTIME_VERSION}
